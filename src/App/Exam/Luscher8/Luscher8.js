                ...
                {Object.keys(inputs.rows[0].cols).map((col) => {
                  ...
                  return (
                    <Box
                      ...
                      data-testid={
                        'component-luscher8-test-' + 'R-' + row + '-C-' + col
                      }
                    />
                  )
                })}
        ...
        >
          ...
          {Object.keys(props.exam.analysis.rows).map((row) => {
            return (
              ...
              >
                {Object.keys(props.exam.analysis.rows[row].terms).map(
                  (term) => {
                    return (
                      <Box
                      ...
                      >
                        ...
                        <Typography variant="h5">
                          {props.exam.analysis.rows[row].terms[term][0] +
                            ' ' +
                            props.exam.analysis.rows[row].terms[term][1]}
                        </Typography>
                      </Box>
                    )
                  }

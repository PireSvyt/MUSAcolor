...
export default function Exercise(props) {
  ...
  return (
    <Accordion
      ...
      expanded={
        props.expanded !== null ? props.expanded === props.index : false
      }
      onChange={() => {
      ...
      <AccordionDetails>
        ...
        >
          ...
          props.exercise.posology === '' ? null : (
            ...
            >
              <Typography variant="overline" color={'grey'} align="left">
          ...
          {props.exercise.data === undefined ? null : props.exercise.data
              .videoToken === undefined ? null : (
            <Box
              sx={{
                display: 'flex',

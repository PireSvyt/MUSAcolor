...
export default function PrescriptionCard(props) {
  ...
  let changes = {
    goto: () => {
      window.location =
        '/prescription?prescriptionid=' + props.prescription.prescriptionid
    },
    openMenu: (event) => {
    ...
    copyurl: () => {
      navigator.clipboard.writeText(
        window.location.origin +
          '/prescription/' +
          props.prescription.prescriptionid
      )
      setMenuOpen(false)
    },
    test: () => {
            ...
            <Box>
              ...
              >
                <MenuItem
                  ...
                  disabled={deleting}
                  data-testid={
                    'listitem-prescription-menuitem-delete+' + props.index
                  }
                >
                  <ListItemIcon>
                ...
                <MenuItem
                  ...
                  data-testid={
                    'listitem-prescription-menuitem-test+' + props.index
                  }
                >
                  <ListItemIcon>
            ...
            >
              ...
              >
                {props.prescription.exercises.map((exercise) => {
                  let ex = select.myexercises.filter(
                  ...
                  if (ex === undefined) {
                    ...
                    if (ex.exerciseid === 'userDefined') {
                      return (
                        <Chip
                          key={random_id()}
                          label={t('exercise.label.customExercise')}
                          size="small"
                          sx={{ mr: 0.5, mt: 0.5 }}
                        />
                      )
